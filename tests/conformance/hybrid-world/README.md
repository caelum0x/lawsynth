# Hybrid world capability boundary
...
Event-driven hybrid world bundle semantics are not implemented by the current deterministic continuous/discrete runtime.
