# Regime world capability boundary
...
Regime schedules are available as in-memory validation primitives, but regime-specific bundle encoding and simulation are not implemented by this runtime.
