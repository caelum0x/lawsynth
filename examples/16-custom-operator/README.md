...
Custom expression operators require the plugin ABI, which is not present in this build. The commands exit with status 2 rather than synthesizing a result.
