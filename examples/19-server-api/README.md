...
The HTTP server is not compiled into this workspace; use the CLI or Python SDK locally. The commands exit with status 2 rather than synthesizing a result.
